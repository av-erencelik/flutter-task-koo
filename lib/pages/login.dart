        ...
        child: ElevatedButton(
            onPressed: () async {
              if (_formKey.currentState!.validate()) {
                ...
                _supabaseController.signInUser(context, email: email, password: password);
              }
            },
            child: Text("Login",
                style: Theme.of(context)
      ...
      child: TextButton(
        ...
        child: Text(
          ...
          style: Theme.of(context)
              .textTheme
              .bodyMedium
              ?.copyWith(fontSize: 11, fontWeight: FontWeight.w400, color: Theme.of(context).colorScheme.onSecondary),
        ),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      style: Theme.of(context)
          .textTheme
          .bodyMedium
          ?.copyWith(fontSize: 14, fontWeight: FontWeight.w400, color: Theme.of(context).colorScheme.onSecondary),
...
class Validators {
  ...
  final passwordValidator = ValidationBuilder().minLength(6).maxLength(50).build();
  final usernameValidator = ValidationBuilder().minLength(3).maxLength(20).build();
}
